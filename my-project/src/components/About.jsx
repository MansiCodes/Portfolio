            ...
            <button
              ...
              className={`${
                tab === "education"
                  ...
                  : "bg-transparent"
              } px-6 py-2 rounded-full border-2 border-white text-white transition-all duration-300 ease-in-out hover:bg-gradient-to-r hover:from-[#6A1B6E] hover:to-[#0B4C7D] transition-all duration-300`}
            >
              Education
            </button>
            <button
